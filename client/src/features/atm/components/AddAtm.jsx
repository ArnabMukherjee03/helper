  ...
  return (
    <div className='bg-white fixed h-[80vh] w-[90%] lg:w-[60%] top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] black z-50 px-10'>
       ...
       <div className="w-full lg:w-1/2 flex gap-4 flex-col">
          <input type="text" placeholder='Enter Atm Title' className='font-thin placeholder:tracking-[0.5px] w-full pb-2 font-secondary text-black text-xs outline-none border-black border-b-[1px]' />
          <input type="text" placeholder='Enter Address' className='font-thin placeholder:tracking-[0.5px] w-full pb-2 font-secondary text-black text-xs outline-none border-black border-b-[1px]' />
          <input type="text" placeholder='Enter Helpline No' className='font-thin placeholder:tracking-[0.5px] w-full pb-2 font-secondary text-black text-xs outline-none border-black border-b-[1px]' />
          <div className="flex gap-4">
            <select className='w-1/2 text-xs font-secondary border-[1px] outline-none border-black py-2' name="" id="">
                <option value="SBI">SBI</option>
                <option value="PNB">PNB</option>
            </select>
            <input type="text" placeholder='Enter City' className='font-thin placeholder:tracking-[0.5px] w-1/2 pb-2 font-secondary text-black text-xs outline-none border-black border-b-[1px]' />
          </div>
          <div className="flex gap-4">
          <div className="mt-1 cursor-pointer font-secondary text-sm rounded-[4px] py-2 px-4 bg-yellow-400 w-[120px] text-center">Save</div>
